...
ALTER TABLE app_users
  ADD COLUMN IF NOT EXISTS can_score_radar BOOLEAN NOT NULL DEFAULT FALSE;

ALTER TABLE app_users
  ADD COLUMN IF NOT EXISTS can_manage_radar_fields BOOLEAN NOT NULL DEFAULT FALSE;
